...
class SfYyJsonParser {
	...
	**/
	static public inline function parse(str:String, v23:Bool) : Dynamic {
		return new SfYyJsonParser(str, v23).doParse();
	}
	...
	function new( str : String, v23:Bool ) {
		this.str = str;
		this.pos = 0;
		this.v23 = v23;
	}
	...
	function parseRec() : Dynamic {
		while( true ) {
			...
			case '{'.code:
				var hxOrder = [];
				var obj:Dynamic, hxOrder:Array<String>;
				if (v23) {
					hxOrder = [];
					obj = { hxOrder: hxOrder };
				} else {
	...
	function parseNumber( c : Int ) : Dynamic {
		...
		if (i == f) {
			...
			var i64 = Int64.parseString(numstr);
